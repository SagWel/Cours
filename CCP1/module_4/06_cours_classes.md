# les classes
* source : https://developer.mozilla.org/fr/docs/Web/JavaScript/Reference/Classes


## Définition
- Les classes JavaScript ont été introduites avec ECMAScript 2015. 
- Elles sont un « sucre syntaxique » par rapport à l'héritage prototypal. 
...
Puisque cette fonction est toujours en développement dans certains navigateurs, veuillez consulter [le tableau de compatibilité](https://developer.mozilla.org/fr/docs/Web/JavaScript/Reference/Classes#compatibilit%C3%A9_des_navigateurs)  pour les préfixes à utiliser selon les navigateurs.
